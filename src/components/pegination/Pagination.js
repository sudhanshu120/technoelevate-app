...
const Pagination = ({ showPerPage, onPaginationChange, total ,setshowPerPage}) => {
    ...
    return (
            ...
            <nav aria-label="Page navigation example">
                ...
                <a style={{border:'1px solid #00000029',color:'gray'}} id="link"
                href="#"
              ...
              {arrOfCurrButtons.map(((item, index) => {
                return <a style={{border:'1px solid #00000029'}}  id="link"
                  href="#"
                  key={index}
